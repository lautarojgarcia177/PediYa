...
@Component({
  selector: 'pedi-ya-host-for-test',
  template: ''
})
class HostComponent {
  actionHandler = () => {};
...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template =
      '<pedi-ya-big-input-action></pedi-ya-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<pedi-ya-big-input-action [disabled]="true"></pedi-ya-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<pedi-ya-big-input-action fontSet="fas" fontIcon="fa-trash"></pedi-ya-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<pedi-ya-big-input-action label="delete"></pedi-ya-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<pedi-ya-big-input-action (action)="actionHandler()"></pedi-ya-big-input-action>';
    fixture = createHostComponent(template);
